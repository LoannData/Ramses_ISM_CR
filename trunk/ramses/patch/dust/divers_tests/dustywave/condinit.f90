...
subroutine condinit(x,u,dx,nn)
  ...
  real(dp)::xn,x0,sum_dust, t_stop, sound_speed,rho_0, epsilon_0, delta_rho0,v0, pi,P_0
      pi = 3.14159265358979323846264_dp
      rho_0     = 2.0_dp
      epsilon_0 = 0.5_dp
      delta_rho0= 1.0e-4_dp
      v0  = 1.0e-4_dp
      sound_speed = 1.0_dp*sqrt(gamma)
      q(1:nn,2)=0.0d0
      q(1:nn,3)=0.0d0
      q(1:nn,4)=0.0d0
      q(1:nn,5)=0.0d0
      ...
      do i=1, nn
         ...
         q(i,5)=q(i,1)*(1.0_dp-epsilon_0)*sound_speed*sound_speed 
      end do
