...
! declare local variables
  INTEGER ::i, j, k, l, m, n, ht,h, idust
...
!                  print*,rhox,epsx,rhoy,epsy,rhoz,epsz
                  call temperature_eos((1.0_dp-sum_dust)*rhox,epsx,tcellx,ht)
                  call temperature_eos((1.0_dp-sum_dust)*rhoy,epsy,tcelly,ht)
                  call temperature_eos((1.0_dp-sum_dust)*rhoz,epsz,tcellz,ht)
!!$                  tcelly=10.
!!$                  tcellx=10.
!!$                  tcellz=10.
               endif
...
#if Ndust >0
                    do idust = 1, n_dust
                       sum_dust =sum_dust + u(l,i,j,k,firstindex_ndust+idust)/rhof
                    end do
#endif   
                    else 
                       call temperature_eos((1.0_dp-sum_dust)*rhof,epsf,tcellf,ht)
                    endif
...
#endif                       
                 call temperature_eos((1.0_dp-sum_dust)*rhocell,u(l,i,j,k,nvar),tcell,ht)
!                if(nmagdiffu2.eq.1)call temperature_eos((1.0_dp-sum_dust)*rhocell,u(l,i,j,k,3),tcell,ht)
                 end if
...
#endif                            
                 call temperature_eos((1.0_dp-sum_dust)*u(l,i,j,k,1),u(l,i,j,k,nvar),tcell,ht)
                 if(nambipolar2.eq.1)call temperature_eos((1.0_dp-sum_dust)*u(l,i,j,k,1),u(l,i,j,k,3),tcell,ht)
              end if
...
!                     tcell=1.0d0
!                  else
! TAKE IN ACCOUNT DUST IF YOU UNCOMMENT AND EVERYWHERE temperature_eos IS CALLED             
!                     call temperature_eos(q(l,i,j,k,1),q(l,i,j,k,nvar),tcell,ht)
!                  endif
!                  bcell = A*A + B*B + C*C
!                  sp0 = sp0 +(gamma-1.d0)*etaohmdiss(q(l,i,j,k,1),bcell,tcell)*jcentersquare(l,i,j,k)*dt
