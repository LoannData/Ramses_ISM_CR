...
set output 'nimhd-cshock-ohm.ps'
...
plot file1 u 1:4 w p pt 4 ps 1 lw 2, file6 u 1:2 w l lt -1 lw 2

set ylabel 'Vx (cm/s)' offset 2.0
plot file2 u 1:4 w p pt 4 ps 1 lw 2, file6 u 1:3 w l lt -1 lw 2

set ylabel 'Vy (cm/s)' offset 2.0
plot file3 u 1:4 w p pt 4 ps 1 lw 2, file6 u 1:4 w l lt -1 lw 2

set ylabel 'By' offset 2.0
plot file4 u 1:4 w p pt 4 ps 1 lw 2, file6 u 1:6 w l lt -1 lw 2

set ylabel 'Pressure (g/cm/s2)' offset 2.0
plot file5 u 1:4 w p pt 4 ps 1 lw 2, file6 u 1:7 w l lt -1 lw 2
