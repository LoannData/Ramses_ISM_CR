...
contains
  ...
  subroutine pre_backup_part()
    ! This subroutine is called just before the particles are dumped

  end subroutine pre_backup_part

  subroutine post_backup_part()
    ! This subroutine is called just before the particles are dumped

  end subroutine post_backup_part
