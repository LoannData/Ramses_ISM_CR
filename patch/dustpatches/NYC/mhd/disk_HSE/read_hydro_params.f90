subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,initfile,multiple,nregion,region_type &
       ...
       & ,d_region,u_region,v_region,w_region,p_region,disk_aspect,disk_exp_limit,disk_soft,disk_R0 &
       & ,disk_shear_forcing,disk_xc,disk_yc,disk_zc,disk_trans_fact,disk_smooth_VertRho &
       & ,disk_innerR,disk_outerR,disk_outerR2,disk_innerR0,disk_outerR0,disk_testR,disk_testz,disk_vramp &
       & ,disk_vrms,disk_raiseP_factor,disk_B0,disk_By,disk_Bz &
       & ,disk_V0,disk_P0,disk_D0,disk_D1,disk_Mass,disk_thetaMax,disk_ratio,disk_nsubsample &
       & ,disk_T0,disk_T1,disk_setup,disk_m,disk_R200,disk_R1,disk_H1,disk_conc,disk_rho_pow &
       & ,disk_cs_pow,disk_abar,disk_Textra,disk_readTable,disk_TableLevel,disk_mag_scaleR,disk_mag_scaleH &
       & ,disk_mag_scaleBr,disk_mag_scaleBh,disk_mag_pow,grav_angle,grav_width,disk_delta_alpha &
#if NENER>0
       & ,prad_region &
#endif
#if NVAR>8+NENER
  ...
  namelist/hydro_params/gamma,courant_factor,smallr,smallc &
       & ,niter_riemann,slope_type,slope_mag_type,apply_relaxation,relaxation_unew_uold &
       & ,relaxation_time,relaxation_step,relax_factor,relax_revert &
       & ,relaxation_OuterRadius,relaxation_InnerRadius &
#if NENER>0
       & ,gamma_rad &
#endif
  ...
  namelist/refine_params/x_refine,y_refine,z_refine,r_refine &
       ...
       & ,interpol_var,interpol_type,interpol_mag_type,sink_refine,disk_refine,middle_refine
