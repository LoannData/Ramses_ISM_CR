subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,initfile,multiple,nregion,region_type &
       ...
       & ,disk_shear_forcing &
       & ,disk_xc,disk_yc,disk_zc &
       & ,disk_exp_limit,disk_R0,disk_innerR,disk_outerR,disk_outerR2,disk_innerR0,disk_outerR0 &
       & ,disk_testR,disk_testz,disk_vramp,disk_vrms,disk_raiseP_factor,disk_smooth_vertRho &
       & ,disk_V0,disk_P0,disk_D0,disk_D1,disk_Mass,disk_thetaMax,disk_ratio,disk_trans_fact,disk_aspect &
       & ,disk_T0,disk_setup,disk_m,disk_R200,disk_R1,disk_H1,disk_conc,disk_rho_pow,disk_nsubsample &
       & ,disk_cs_pow,disk_abar,disk_Textra,disk_readTable,disk_TableLevel,grav_angle,grav_width &
       & ,disk_delta_alpha

  namelist/hydro_params/gamma,courant_factor,smallr,smallc &
       & ,niter_riemann,slope_type,difmag,apply_relaxation,relaxation_unew_uold &
  ...
  namelist/refine_params/x_refine,y_refine,z_refine,r_refine &
       ...
       & ,interpol_var,interpol_type,sink_refine,disk_refine,cen_refine,middle_refine
