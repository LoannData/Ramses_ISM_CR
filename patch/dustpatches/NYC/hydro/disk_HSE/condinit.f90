...
subroutine condinit(x,u,dx,nn,first_lmax)
  ...
  real(dp)::pmin,R_integral,R_left,R_right,tmin,temp_zero,temp_minus1
  real(dp)::dR,dz,r_loop,z_loop,rho,rho_l,rho_r,temp,temp_l,temp_r,pres,&
...
! Saving parameters to local variables to tidy up their use below
  ...
  Tmin = pmin/(D1/scale_d) ! Here and below I call T = P/rho; it's really cs^2
