subroutine init_hydro
  ...
  integer::irad
#endif
  integer::nvar2,ilevel2,numbl2,ilun,ibound,idim,istart,idisk
  ...
  dflux_dust =0.0d0; v_dust=0.0d0;dflux_dust_eint=0.0d0!  v_dust_0=0.0d0;
  jdust=1
#endif
...
if(use_resist) then         
   do idisk=1,nstore_disk
           ...
           read(ilun)xx
           do i=1,ncache
              store_disk(ind_grid(i)+iskip,idisk)=xx(i)
