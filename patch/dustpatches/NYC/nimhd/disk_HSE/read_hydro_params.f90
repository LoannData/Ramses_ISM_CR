subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,initfile,multiple,nregion,region_type &
       ...
       & ,disk_T0,disk_setup,disk_m,disk_R200,disk_R1,disk_H1,disk_conc,disk_rho_pow &
       & ,disk_cs_pow,disk_abar,disk_Textra,disk_readTable,disk_TableLevel,disk_mag_scaleR,disk_mag_scaleH &
       & ,disk_mag_scaleBr,disk_mag_scaleBh,disk_mag_pow,grav_angle,grav_width &
#if NENER>NGRP
       & ,prad_region &
#endif
#if NGRP>0
  ...
  namelist/hydro_params/gamma,courant_factor,smallr,smallc,smallcr, dtdiff_params,dt_control &
       ...
       &,apply_relaxation,relaxation_unew_uold &
       & ,relaxation_time,relaxation_step,relax_factor,relax_revert,relax_ndecay &
