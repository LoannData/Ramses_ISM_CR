...
! Cosmic rays energy groups
  ...
  real(dp)::floor_dust=1.d-40   ! Dust concentration floor
  ...
  real(dp)::disk_innerR=0.5
  real(dp)::disk_outerR=5.5
  real(dp)::disk_outerR2=19.8  ! Transition radius to second outer boundary, i.$
  real(dp)::disk_innerR0=0.1
  real(dp)::disk_outerR0=5.75
  real(dp)::disk_V0=2.0
  real(dp)::disk_vramp=0.9d0
  ...
  real(dp)::disk_T1=1.d10
  real(dp)::disk_setup=1
  real(dp)::disk_m=0.5
