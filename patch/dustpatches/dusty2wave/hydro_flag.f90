  ...
  do igrid=1,ncache,nvector
     ...
     do ind=1,twotondim
        ...
        ! Apply geometry-based refinement criteria
           ...
           if(dustywave_refine>0) then
           call wave_refine(xx,ok,ngrid,ilevel)
        endif
...
subroutine wave_refine(xx,ok,ncell,ilevel)
  use amr_commons
  use pm_commons
  use hydro_commons
  use poisson_commons
  ...
  real(dp)::er,xr,yr,zr,xn,yn,zn,r,aa,bb,res,rin,rout,drrho,rrdr,radius,radiusdr,csdr,rho0,cs0
     ...
     do i=1,ncell
        ...
        ok(i)=ok(i).or.abs(xn-xr)<0.25d0
     end do

     

   end subroutine wave_refine
