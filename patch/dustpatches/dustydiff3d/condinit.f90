...
subroutine condinit(x,u,dx,nn)
  ...
  real(dp)::xn,x0,yn,zn,rsquare,sum_dust, t_stop, sound_speed,rho_0, epsilon_0, r_c
      ...
      do i=1, nn
         ...
         do idust = 1, Ndust
              ...
              if (1.0_dp .gt. rsquare ) then
                 q(i,firstindex_ndust+idust) = epsilon_0*(1.0_dp -rsquare)
              else
