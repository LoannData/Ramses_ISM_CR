     ...
     if(nx_sample==0)then
        do j=jmin,jmax
           do i=imin,imax
              ...
              if(do_max)then
                 write(20,'(10(es17.8e3,1x))')xx,yy,grid(lmax)%map(i,j)
              else
                 write(20,'(10(es17.8e3,1x))')xx,yy,grid(lmax)%map(i,j)/grid(lmax)%rho(i,j)
              endif
           end do
           write(20,*) " "
        end do
        ...
        do j=0,ny_sample
           do i=0,nx_sample
              ...
              write(20,'(10(es17.8e3,1x))')xx,yy,toto(i,j)
           end do
           write(20,*) " "
        end do
     endif
