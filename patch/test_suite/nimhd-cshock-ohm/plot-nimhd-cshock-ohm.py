...
# Density
density = subplot(321)
density.plot(data6[:,0],data6[:,1],color='red')
...
# Vx
vx = subplot(322)
vx.plot(data6[:,0],data6[:,2],color='red')
...
# Vy
vy = subplot(323)
vy.plot(data6[:,0],data6[:,3],color='red')
...
# By
by = subplot(324)
by.plot(data6[:,0],data6[:,5],color='red')
...
pressure.plot(data6[:,0],data6[:,6],color='red')
