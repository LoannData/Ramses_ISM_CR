           ...
           if(dust_barr) pressure = (1.0_dp-sum_dust)*d*cs*cs
            ...
            do idust = 1,ndust
               ...
               do idim=1,ndim
                  ...
                  if (dust_diffusion.eqv.false)  v_dust(ind_cell(i),idust,idim)=0.0d0
        ...
        do i=1,ngrid
           ...
           if(dust_barr) pressure = (1.0_dp-sum_dust)*d*cs*cs
            ...
            do idust = 1,ndust
               t_stop(idust) = t_stop(idust)+tstop_tot
               do idim=1,ndim
                  v_dust_0(ind_cell(i),idust,idim)=0.0d0
                  if(decay_dust) v_dust_0(ind_cell(i),idust,idim)=-t_stop(idust)*(gradP(i,idim))/d
                  v_dust(ind_cell(i),idust,idim)= t_stop(idust)*(gradP(i,idim))/d+v_dust_0(ind_cell(i),idust,idim)
...
end subroutine init_vdust




subroutine set_vdust_decay(ilevel)
  use amr_commons
  use hydro_commons
  use units_commons
  use cloud_module
        ...
        do i=1,ngrid
           ...
           if(dust_barr) pressure = (1.0_dp-sum_dust)*d*cs*cs
            ...
            do idust = 1,ndust
               t_stop(idust) = t_stop(idust)+tstop_tot
               do idim=1,ndim
                  v_dust_0(ind_cell(i),idust,idim) = v_dust_0(ind_cell(i),idust,idim)*(1.0d0-exp(-dtnew(ilevel)/t_stop(idust)))
		end do	  
            end do
         end do
   end do
...
end subroutine set_vdust_decay
