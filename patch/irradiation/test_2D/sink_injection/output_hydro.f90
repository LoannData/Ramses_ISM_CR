...
#ifdef RT
  do ivar=1,nGroups
     write(ilun,'("variable #",I2,": photon_number_flux_",I1)')nvar+4+(ivar-1)*(ndim+1)+1,ivar
     write(ilun,'("variable #",I2,": photon_number_xflux_",I1)')nvar+4+(ivar-1)*(ndim+1)+2,ivar
     write(ilun,'("variable #",I2,": photon_number_yflux_",I1)')nvar+4+(ivar-1)*(ndim+1)+3,ivar
     write(ilun,'("variable #",I2,": photon_number_zflux_",I1)')nvar+4+(ivar-1)*(ndim+1)+4,ivar
  end do
#endif
