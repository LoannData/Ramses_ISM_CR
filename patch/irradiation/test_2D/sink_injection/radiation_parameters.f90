...
subroutine init_opacities_pascucci
  ...
  do while(.true.)
     ...
     opknul(i) = dum1
     !if scattering with weingardner opacities opknul(i) = dum2 !dum1 ! dum1 + dum2
     i = i + 1
  enddo
  556 continue
  close(46)
  ...
  do i = 1,n
     ...
     opknu(i) = opknul(i) * grain_size**2 / grain_mass / 100_dp !dust to gas ratio, for drainelee opacities
