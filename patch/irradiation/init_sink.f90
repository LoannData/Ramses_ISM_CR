...
!!$  use cooling_module,only: clight
  ...
  integer::ilun
  real(dp)::xx1,xx2,xx3,vv1,vv2,vv3,mm1,ll1,ll2,ll3!!,radiation_source,pi
...
!        read(ilun)ncloud_sink
  ...
  if (nrestart>0)then
     ...
     rstar_init=r_starsink1
     rsink_star(1) = rstar_init*Rsun/scale_l
