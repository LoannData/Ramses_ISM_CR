subroutine read_hydro_params(nml_ok)
  ...
  ! Local variables  
  !--------------------------------------------------
  integer::i,idim,nboundary_true=0,ivar
  ...
  namelist/hydro_params/gamma,courant_factor,smallr,smallc,smallcr,Tfloor,RelVar &
       & ,niter_riemann,slope_type,slope_mag_type,positivity_type &
#if NENER>0
       & ,gamma_rad &
#endif
